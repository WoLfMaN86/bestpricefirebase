<template>
  <div class="col-md-12 mx-auto">
    <h2 class="titulo">
      Lista de productos originales
      <button class="btn btn-add" @click="irAOriginales">Añadir Nuevo</button>
    </h2>
    <div
...
import EditarProducto from "./OriginalesEditar.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    irAOriginales() {
      this.router.push("/originales/add");
    },
  },
});
</script>
