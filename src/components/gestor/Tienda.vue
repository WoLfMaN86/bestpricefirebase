    ...
    tiendasFiltradas() {
      ...
      if (this.filtroCodPostal) {
        tiendas = tiendas.filter((tienda) =>
          tienda.codPostal
            .toLowerCase()
            .includes(this.filtroCodPostal.toLowerCase())
        );
      }
      ...
      switch (this.orden) {
        case "ascendente":
          tiendasList.sort((a, b) => a.nombre.localeCompare(b.nombre));
          break;
        case "descendente":
          tiendasList.sort((a, b) => b.nombre.localeCompare(a.nombre));
          break;
        case "sin-filtros":
          // No aplica orden
          break;
